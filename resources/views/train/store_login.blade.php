        ...
        <div class="row align-items-center" style="height:650px;">
            ...
            <div class="col-4 offset-4">
                ...
                <div ng-controller="myCtrl">
                    ...
                    <div class="mb-3">
                        <label for="ex1" class="form-label">店家名稱</label>
                        <input type="text" class="form-control" id="ex1" ng-model="storeName">
                    </div>
                    <div class="mb-3">
                        <label for="ex2" class="form-label">密碼</label>
                        <input type="password" class="form-control" id="ex2" ng-model="storePw">
                    </div>
                    <br>
...
<script>
    ...
    app.controller('myCtrl', function($scope) {
        ...
        $scope.login = function() {
            ...
            if ($scope.storeName == "" || $scope.storePw == "") {
                $scope.login_err = "請填入帳號&密碼";
                return;
            }

            console.log($scope.storeName);
            console.log($scope.storePw);

            axios.post('/store_login', {
                storeName: $scope.storeName,
                storePw: $scope.storePw,
            }).then(response => {

                if (response.data.state) {
                    console.log(response.data);
                    window.location.href = '/store_manage';
                }
