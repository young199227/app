...
(9, 5, '1', 50, 0, '2023-03-29 16:00:00'),
...
CREATE TABLE IF NOT EXISTS `items_car` (
  ...
  KEY `itemsId` (`ItemsId`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='購物車';
...
(11, 10, 4, 2, 360000, '2023-04-25 09:58:07'),
(12, 10, 5, 2, 10, '2023-04-25 09:58:12');
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  PRIMARY KEY (`OrderId`),
  KEY `CustomerId` (`CustomerId`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='訂單表格';
...
(2, 5, 900000, '2023-03-29 16:00:00'),
(3, 5, 700000, '2023-03-29 16:00:00'),
(4, 5, 800000, '2023-03-29 16:00:00'),
...
(13, 5, 600000, '2023-03-29 16:00:00'),
(14, 5, 800000, '2023-03-29 16:00:00'),
...
(23, 5, 800000, '2023-03-29 16:00:00'),
(24, 5, 600000, '2023-03-29 16:00:00'),
(25, 6, 500000, '2023-03-31 11:30:00'),
(28, 10, 1080030, '2023-04-25 09:42:12'),
(30, 10, 1080030, '2023-04-25 09:42:55'),
(31, 10, 1080030, '2023-04-25 09:48:19'),
(32, 10, 1080030, '2023-04-25 09:50:12'),
(33, 10, 1080030, '2023-04-25 09:55:04'),
(34, 10, 0, '2023-04-26 05:02:00'),
(35, 5, 720000, '2023-03-26 12:00:00'),
(36, 5, 540000, '2023-03-25 12:00:00'),
(37, 5, 180000, '2023-03-26 12:00:00');
...
CREATE TABLE IF NOT EXISTS `order_content` (
  ...
  KEY `OrderId` (`OrderId`),
  KEY `ItemId` (`ItemsId`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='訂單內容表格';
...
(2, 2, 4, 5, 900000, '2023-03-29 16:00:00'),
(3, 3, 3, 8, 120, '2023-03-29 16:00:00'),
(4, 3, 4, 2, 360000, '2023-03-29 16:00:00'),
(5, 4, 5, 20, 100, '2023-03-29 16:00:00'),
(6, 4, 3, 5, 75, '2023-03-29 16:00:00'),
...
(23, 13, 5, 8, 40, '2023-03-29 16:00:00'),
(24, 13, 3, 5, 75, '2023-03-29 16:00:00'),
(25, 14, 4, 5, 900000, '2023-03-29 16:00:00'),
(26, 28, 4, 6, 1080000, '2023-04-25 09:48:19'),
(27, 28, 3, 1, 15, '2023-04-25 09:48:19'),
(28, 28, 5, 3, 15, '2023-04-25 09:48:19'),
(29, 28, 4, 6, 1080000, '2023-04-25 09:50:12'),
(30, 28, 3, 1, 15, '2023-04-25 09:50:12'),
(31, 28, 5, 3, 15, '2023-04-25 09:50:12'),
(32, 28, 4, 6, 1080000, '2023-04-25 09:55:04'),
(33, 28, 3, 1, 15, '2023-04-25 09:55:04'),
(34, 28, 5, 3, 15, '2023-04-25 09:55:04');
